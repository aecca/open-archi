        ...
        return a.map(function (s) {
            ...
            switch (type) {
                ...
                case "float":
                    ...
                    break;
                case "date":
                    result = !format ? new Date(s) : s.toDate(format);
                    break;
                default:
                    result = s.trim();
            }
            ...
            return a.map(function (s) {
                ...
                switch (type) {
                    ...
                    case "float":
                        ...
                        break;
                    case "date":
                        result = !Utils.isValue(format) ? new Date(s) : s.toDate(format);
                        break;
                    default:
                        result = s.trim();
                }
                ...
                if (this.readyState === 4) {
                    ...
                    if (this.status === 200) {
                        switch (o.insertMode.toLowerCase()) {
                            case "prepend":
                                element.prepend(this.responseText);
                                break;
                            case "append":
...
// Source: js/plugins/image-comparer.js
    var ImageCompare = {
        ...
        _createStructure: function () {
            ...
            switch (o.height) {
                case "16/9":
                    element_height = Utils.aspectRatioH(element_width, o.height);
                    break;
                case "21/9":
                    element_height = Utils.aspectRatioH(element_width, o.height);
                    break;
    ...
    var List = {
        ...
        _getItemContent: function (item) {
            ...
            if (Utils.isValue(format)) {
                ...
                switch (format) {
                    case "date":
                        data = Utils.isValue(formatMask) ? data.toDate(formatMask) : new Date(data);
                        break;
                    case "number":
                        data = Number(data);
                        break;
...
// Source: js/plugins/table.js
    var Table = {
        ...
        _createStructure: function () {
            ...
            var w_search = $(o.searchWrapper), w_info = $(o.infoWrapper), w_rows = $(o.rowsWrapper),
                w_paging = $(o.paginationWrapper);
        ...
        _getItemContent: function (row) {
            ...
            if (Utils.isValue(format)) {
                ...
                switch (format) {
                    case "date":
                        result = Utils.isValue(formatMask) ? result.toDate(formatMask) : new Date(result);
                        break;
                    case "number":
...
// Source: js/plugins/window.js
    ...
    Metro['window'] = {
        ...
        create: function (options) {
            ...
            var w_options = $.extend({}, {}, (options !== undefined ? options : {}));
