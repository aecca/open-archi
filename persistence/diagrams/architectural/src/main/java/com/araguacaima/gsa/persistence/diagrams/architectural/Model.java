...
import com.araguacaima.gsa.persistence.diagrams.core.SequentialIdGeneratorStrategy;
...
public class Model extends Element {
    ...
    private void addRelationshipToInternalStructures(com.araguacaima.gsa.persistence.diagrams.core.Relationship relationship) {
     ...
     */
    public com.araguacaima.gsa.persistence.diagrams.core.Relationship getRelationship(String id) {
    ...
    private void hydrateRelationships(Element element) {
        Set<com.araguacaima.gsa.persistence.diagrams.core.Relationship> relationships = element.getRelationships();
        for (com.araguacaima.gsa.persistence.diagrams.core.Relationship relationship : relationships) {
    ...
    public Set<Relationship> addImplicitRelationships() {
        ...
        Set<com.araguacaima.gsa.persistence.diagrams.core.Relationship> relationships = getRelationships();
        for (com.araguacaima.gsa.persistence.diagrams.core.Relationship relationship : relationships) {
    ...
    ContainerInstance addContainerInstance(Container container) {
        ...
        for (ContainerInstance ci : containerInstances) {
            ...
            Set<com.araguacaima.gsa.persistence.diagrams.core.Relationship> relationships = container.getRelationships();
            for (com.araguacaima.gsa.persistence.diagrams.core.Relationship relationship : relationships) {
            ...
            Set<com.araguacaima.gsa.persistence.diagrams.core.Relationship> relationships1 = c.getRelationships();
            for (com.araguacaima.gsa.persistence.diagrams.core.Relationship relationship : relationships1) {
                Relationship relationship_ = (Relationship) relationship;
