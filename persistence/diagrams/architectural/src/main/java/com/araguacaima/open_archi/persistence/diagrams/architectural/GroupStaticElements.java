...
public abstract class GroupStaticElements extends StaticElements {
    ...
    public Collection<BaseEntity> override(GroupStaticElements source, boolean keepMeta, String suffix, CompositeElement clonedFrom) {
        return super.override(source, keepMeta, suffix, clonedFrom);
    }

    public Collection<BaseEntity> copyNonEmpty(GroupStaticElements source, boolean keepMeta) {
